# DraBornOdds v0.1 çalışma kaydı

- Demo uygulama ve tüm ana ekranlar tamamlandı.
- Expo Go 58 / SDK 58 beta hedefi sabit. Veritabanı veya APK yok.
- Hesaplama, filtre, risk, tutar sınırı ve kayıt doğrulamasındaki 14 test geçti.
- Gerçek web paketine karşı 3 DOM senaryo testi geçti: otomatik kupon + kaydet/yeniden aç; maç analizi + elle kupon; ana ekranlar ve geçersiz bağlantılar.
