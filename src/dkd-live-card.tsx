...
export function dkd_LiveMatchCard(dkd_props:{dkd_match:dkd_Match;dkd_featured?:boolean}){
  ...
  if(dkd_match.dkd_markets.length>0)return <dkd.MatchCard dkd_match={dkd_match} dkd_featured={dkd_props.dkd_featured}/>;
